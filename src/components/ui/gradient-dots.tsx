...
export function GradientDots({
    ...
    return (
        <motion.div
          ...
          radial-gradient(circle at 50% 50%, transparent 1.5px, ${backgroundColor} 0 ${dotSize}px, transparent ${dotSize}px),
          radial-gradient(circle at 50% 50%, #c0392b, transparent 60%),
          radial-gradient(circle at 50% 50%, #922b21, transparent 60%),
          radial-gradient(circle at 50% 50%, #e74c3c, transparent 60%),
